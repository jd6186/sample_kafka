...
public class KafkaTopicConfig {
    ...
    @Bean
    public NewTopic AdManager() {
        return new NewTopic("ad-manager", 10, (short) 3);
    }

    @Bean
    public NewTopic AdScheduledDataTransfer() {
        return new NewTopic("ad-scheduled-data-transfer", 10, (short) 3);
    }
